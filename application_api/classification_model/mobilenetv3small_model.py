...
def classify(file):
    ...
    xgb_path = default_storage.path('model/' + 'xgb_model_mobilenetv3small-3-norm.json')
    lgb_path = default_storage.path('model/' + "lgb_mobilenetv3small-3-norm.pkl")
    cb_path = default_storage.path('model/' + "cb_mobilenetv3small-3-norm.pkl")
